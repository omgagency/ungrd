...
export class RegisterComponent implements OnInit {
  ...
  ciudades_orden = this.ciudades.sort()
  ...
  onChange(event) {
    switch (event) {
      case this.proveedores[0]:
        ...
        document.getElementById("certificado-text").innerHTML = "Certificado de existencia y representación Legal o Registro mercantil";
        document.getElementById("rup-text").innerHTML = "RUP o estados financieros del último año (2019)";
      ...
      case this.proveedores[1]:
        ...
        document.getElementById("certificado-text").innerHTML = "Registro mercantil o su equivalente";
        document.getElementById("rup-text").innerHTML = "Estados financieros del último año (2019)";
