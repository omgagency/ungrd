...
@Component({
  selector: 'app-convocatorias-aplicar-admin',
  templateUrl: './convocatorias-aplicar-admin.component.html',
  styleUrls: ['./convocatorias-aplicar-admin.component.sass']
})
export class ConvocatoriasAplicarAdminComponent implements OnInit {
  ...
  initForm() {
    this.convocatoriaForm = this.fb.group({
      ...
      soporteFile: [, Validators.required]
    });
